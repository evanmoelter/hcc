...
requires explicit setup. New apps create plain PVCs. The completed disposable proof verified R2 recovery,
checksums, ownership, permissions, and a new backup of the restored claim. A fresh verifier passed after
restore cleanup against the same PVC and PV, with all three Longhorn replicas intact.
