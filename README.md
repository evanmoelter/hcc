...
Mealie is restored on Apollo with LAN, public, and Tailscale access and scheduled PVC backups enabled.
Verification of the first PVC snapshot and restore cleanup remain pending.
